      ...
      <table className="table">
        <thead>
          ...
          <tr>
            ...
            <td>
                <button onClick={createUser} type="button" className="btn btn-success" style={{borderRadius: "20px"}}>
                    +
                </button>
            </td>
          </tr>
        ...
        <tbody>
          {users.map((user: any) => (
            <tr key={user._id}>
              ...
              <td>{user.role}</td>
              <td>
                <button onClick={() => deleteUser(user)} type="button" className="btn btn-danger">
                  <BsTrash3Fill />
                </button>
              </td>
            </tr>))}
